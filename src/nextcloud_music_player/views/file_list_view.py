...
class FileListView:
    ...
    def build(self):
        ...
        self.play_button = ft.FilledButton(
            ...
            style=ft.ButtonStyle(
                bgcolor={ft.ControlState.DISABLED: Color.BG_ELEVATED, "": Color.PRIMARY},
        ...
        self.download_button = ft.FilledButton(
            ...
            disabled=True,
            style=ft.ButtonStyle(
                bgcolor={ft.ControlState.DISABLED: Color.BG_ELEVATED, "": Color.BG_ELEVATED},
                color={ft.ControlState.DISABLED: Color.TEXT_DISABLED, "": Color.SUCCESS_TEXT},
                icon_color={ft.ControlState.DISABLED: Color.TEXT_DISABLED, "": Color.SUCCESS},
